...
const SOURCE_DOMAIN = "https://onlyfans.com/centolain"

export class CentolainOnlyfans extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Centolain Onlyfans' }
    get description(): string { return 'Centolain Onlyfans' }
